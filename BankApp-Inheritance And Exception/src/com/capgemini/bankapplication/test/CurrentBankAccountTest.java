...
import com.capgemini.bankapplication.exception.DebitLimitExceededException;
import com.capgemini.bankapplication.model.BankAccount;
import com.capgemini.bankapplication.model.CurrentBankAccount;
...
public class CurrentBankAccountTest {
	...
	public void setUp()
	{
		account = new CurrentBankAccount(100, "Jay", "SAVING", 45000, 10000);
	}
	...
	{
		CurrentBankAccount account = new CurrentBankAccount(100, "Jay", "SAVING", 45000, 10000);
