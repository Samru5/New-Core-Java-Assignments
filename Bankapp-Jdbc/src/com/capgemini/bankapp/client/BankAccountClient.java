			...
			while (true) {
				...
				case 2:
					...
					try {
						...
						System.out.println("After withdraw your balance is-" + bankService.checkBalance(accountId));
				...
				case 4:
					...
					try {
						System.out
								.println(accountBalance = bankService.fundTransfer(fromAccountId, toAccountId, amount));
				...
				case 6:
					System.out.println("Displaying all bank account details-" + bankService.findAllBankAccounts());
					break;
